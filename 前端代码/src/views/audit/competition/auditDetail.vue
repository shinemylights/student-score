<template>
  <div>
        <el-card >
          ...
          <el-row :gutter="8" class="custom-row-spacing">
            <el-col :span="12">
                <span style="font-weight: bold;">竞赛名称</span>
            </el-col>
            <el-col :span="12">
          ...
          <el-row :gutter="8" class="custom-row-spacing">
            <el-col :span="12">
              <span style="font-weight: bold;">竞赛级别</span>
            </el-col>
            <el-col :span="12">
              <span style="vertical-align: middle;">{{ reviewData.level }}</span>
            </el-col>
          </el-row>
          <el-row :gutter="8" class="custom-row-spacing">
            <el-col :span="12">
              <span style="font-weight: bold;">获奖名称</span>
            </el-col>
            <el-col :span="12">
              <span style="vertical-align: middle;">{{ reviewData.title }}</span>
            </el-col>
          </el-row>
          <el-row :gutter="8" class="custom-row-spacing">
            <el-col :span="12">
              <span style="font-weight: bold;">获奖时间</span>
            </el-col>
            <el-col :span="12">
              <span style="vertical-align: middle;">{{ reviewData.date }}</span>
            </el-col>
          </el-row>
            <el-row :gutter="8" class="custom-row-spacing">
              <el-col :span="12">
                <span style="font-weight: bold;">组织单位</span>
              </el-col>
              <el-col :span="12">
            ...
            <el-row :gutter="8" class="custom-row-spacing">
              ...
              <el-col :span="12">
                <span style="vertical-align: middle;">{{ reviewData.category }}</span>
              </el-col>
            </el-row>
...
export default {
  ...
  methods:{
    async approveAward(){
      const res= await this.$axios.get('/audit/contest/approveAward?id=' + this.$route.query.id)
    ...
    async rejectAward(){
      try {
        const res= await this.$axios.get('/audit/contest/rejectAward?id=' + this.$route.query.id)
        if(res.data.code===200){
          // this.adminData={}
          // this.adminDialog=false
          // await this.getReviewById()
    ...
    async getReviewById(){
      const res= await this.$axios.get('/audit/contest/getAuditById?id=' + this.$route.query.id)
